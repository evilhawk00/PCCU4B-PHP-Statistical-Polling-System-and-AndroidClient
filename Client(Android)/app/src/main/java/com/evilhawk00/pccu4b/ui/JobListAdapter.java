...
public class JobListAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    List<JobData> data= Collections.emptyList();
    //JobData current;
    //int currentPos=0;

    // create constructor to innitilize context and data sent from MainActivity
    public JobListAdapter(Context context, List<JobData> data){
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view=inflater.inflate(R.layout.container_overview, parent,false);
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        ...
        JobData current=data.get(position);
